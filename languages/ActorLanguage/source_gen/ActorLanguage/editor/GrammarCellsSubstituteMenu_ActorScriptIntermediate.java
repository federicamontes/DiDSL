...
public class GrammarCellsSubstituteMenu_ActorScriptIntermediate extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActorScriptIntermediate() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActorScriptIntermediate", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_4m9v4e_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_4m9v4e_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActorScriptIntermediate$mu;
    }
  }
