...
public class GrammarCellsSubstituteMenu_ActorLink extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActorLink() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActorLink", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_fg5zw9_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_fg5zw9_a extends GrammarCellsSubstituteMenuPart {
    @Override
