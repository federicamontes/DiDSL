...
public class GrammarCellsSubstituteMenu_GlobalConstant extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_GlobalConstant() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "GlobalConstant", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_m2muyp_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_m2muyp_a extends GrammarCellsSubstituteMenuPart {
    @Override
