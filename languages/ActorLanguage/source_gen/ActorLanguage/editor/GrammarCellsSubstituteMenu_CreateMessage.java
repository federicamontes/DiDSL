...
public class GrammarCellsSubstituteMenu_CreateMessage extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CreateMessage() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CreateMessage", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_es3opz_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_es3opz_a extends GrammarCellsSubstituteMenuPart {
    @Override
