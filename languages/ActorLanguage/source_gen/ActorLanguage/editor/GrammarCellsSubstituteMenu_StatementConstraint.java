...
public class GrammarCellsSubstituteMenu_StatementConstraint extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_StatementConstraint() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "StatementConstraint", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_ymoyko_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_ymoyko_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.StatementConstraint$ik;
    }
  }
