...
public class GrammarCellsSubstituteMenu_CreateActor extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CreateActor() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CreateActor", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_p8l9zy_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_p8l9zy_a extends GrammarCellsSubstituteMenuPart {
    @Override
