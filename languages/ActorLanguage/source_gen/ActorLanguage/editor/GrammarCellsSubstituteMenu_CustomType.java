...
public class GrammarCellsSubstituteMenu_CustomType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CustomType() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CustomType", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_fdbn03_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_fdbn03_a extends GrammarCellsSubstituteMenuPart {
    @Override
