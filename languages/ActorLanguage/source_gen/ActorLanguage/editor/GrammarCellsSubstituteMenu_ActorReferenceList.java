...
public class GrammarCellsSubstituteMenu_ActorReferenceList extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActorReferenceList() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActorReferenceList", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_l5fty0_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_l5fty0_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActorReferenceList$4g;
    }
  }
