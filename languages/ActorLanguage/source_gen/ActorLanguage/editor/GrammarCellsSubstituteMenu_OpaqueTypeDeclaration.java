...
public class GrammarCellsSubstituteMenu_OpaqueTypeDeclaration extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_OpaqueTypeDeclaration() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "OpaqueTypeDeclaration", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_ft1o8h_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_ft1o8h_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.OpaqueTypeDeclaration$jq;
    }
  }
