...
public class GrammarCellsSubstituteMenu_ChangeFetchPolicy extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ChangeFetchPolicy() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ChangeFetchPolicy", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_8yok9c_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_8yok9c_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ChangeFetchPolicy$Nx;
    }
  }
