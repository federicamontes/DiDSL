...
public class GrammarCellsSubstituteMenu_CreateEnvelope extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CreateEnvelope() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CreateEnvelope", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_iw5u9w_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_iw5u9w_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.CreateEnvelope$OK;
    }
  }
