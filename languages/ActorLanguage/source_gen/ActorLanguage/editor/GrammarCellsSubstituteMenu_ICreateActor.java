...
public class GrammarCellsSubstituteMenu_ICreateActor extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ICreateActor() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ICreateActor", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_7r833a_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_7r833a_a extends GrammarCellsSubstituteMenuPart {
    @Override
