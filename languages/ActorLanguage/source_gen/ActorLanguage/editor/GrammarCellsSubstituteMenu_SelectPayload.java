...
public class GrammarCellsSubstituteMenu_SelectPayload extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_naswq3_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_naswq3_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.SelectPayload$Hf;
    }
  }
