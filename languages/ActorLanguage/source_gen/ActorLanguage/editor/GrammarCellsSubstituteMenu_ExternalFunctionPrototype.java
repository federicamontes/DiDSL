...
public class GrammarCellsSubstituteMenu_ExternalFunctionPrototype extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ExternalFunctionPrototype() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ExternalFunctionPrototype", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_ykzb41_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_ykzb41_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ExternalFunctionPrototype$n3;
    }
  }
