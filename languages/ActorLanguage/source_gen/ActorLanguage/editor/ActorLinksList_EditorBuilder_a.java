...
/*package*/ class ActorLinksList_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public ActorLinksList_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_bkbxb9_a");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new linksListHandler_bkbxb9_a0(myNode, getEditorContext());
  ...
  private static class linksListHandler_bkbxb9_a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public linksListHandler_bkbxb9_a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(linksListHandler_bkbxb9_a0.this.getNode(), LINKS.links$O5ec));
      try {
