...
public class GrammarCellsSubstituteMenu_CreateActorReference extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CreateActorReference() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CreateActorReference", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_7bxrev_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_7bxrev_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.CreateActorReference$5e;
    }
  }
