...
public class GrammarCellsSubstituteMenu_SendMessageToNeighbors extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_SendMessageToNeighbors() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "SendMessageToNeighbors", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_rr1t9d_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_rr1t9d_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.SendMessageToNeighbors$yl;
    }
  }
