...
/*package*/ class SwitchPolicy_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SwitchPolicy_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private boolean nodeCondition_aa7j8j_a6a() {
    return (SLinkOperations.getTarget(myNode, LINKS.defaultBlock$QOu8) != null);
  }
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_aa7j8j_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_aa7j8j_b0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
  ...
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_aa7j8j_b0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new switchLabelSingleRoleHandler_aa7j8j_a1a(myNode, LINKS.switchLabel$nNiT, getEditorContext());
    return provider.createCell();
  }
  private static class switchLabelSingleRoleHandler_aa7j8j_a1a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public switchLabelSingleRoleHandler_aa7j8j_a1a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_aa7j8j_b1a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "switch policy");
    editorCell.setCellId("Constant_aa7j8j_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "{");
    editorCell.setCellId("Constant_aa7j8j_d0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new caseListHandler_aa7j8j_e0(myNode, getEditorContext());
  ...
  private static class caseListHandler_aa7j8j_e0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public caseListHandler_aa7j8j_e0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(caseListHandler_aa7j8j_e0.this.getNode(), LINKS.case$8PWE));
      try {
    ...
    private EditorCell createConstant_4() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_aa7j8j_a4a");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
  ...
  private EditorCell createConstant_5() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_aa7j8j_f0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
  ...
  private EditorCell createConstant_6() {
    ...
    editorCell.setCellId("Constant_aa7j8j_a6a");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_7() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_aa7j8j_b6a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new defaultBlockSingleRoleHandler_aa7j8j_c6a(myNode, LINKS.defaultBlock$QOu8, getEditorContext());
    return provider.createCell();
  }
  private static class defaultBlockSingleRoleHandler_aa7j8j_c6a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public defaultBlockSingleRoleHandler_aa7j8j_c6a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_8() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_aa7j8j_h0");
    Style style = new StyleImpl();
