...
public class GrammarCellsSubstituteMenu_StringBody extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_StringBody() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "StringBody", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_ffq5kn_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_ffq5kn_a extends GrammarCellsSubstituteMenuPart {
    @Override
