...
/*package*/ class GlobalConstant_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public GlobalConstant_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private boolean nodeCondition_o3ycrm_a0a0() {
  ...
  private boolean nodeCondition_o3ycrm_a2a0() {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_o3ycrm_a0a0a();
  ...
  private boolean nodeCondition_o3ycrm_a0a0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_o3ycrm_a0a0a");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.GlobalConstant$pG);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.exported$V4am);
          ...
          public SAbstractConcept getOutputConcept() {
            return CONCEPTS.GlobalConstant$pG;
          }
        };
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeSingleRoleHandler_o3ycrm_c0a(myNode, LINKS.type$PEC1, getEditorContext());
    return provider.createCell();
  }
  private static class typeSingleRoleHandler_o3ycrm_c0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeSingleRoleHandler_o3ycrm_c0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.getStyle().putAll(style);
      editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new PropertyCellContext(myNode, property), new SubstituteInfoPartExt[]{new GlobalConstant_component_cellMenu_o3ycrm_a0d0a(), new SChildSubstituteInfoPartEx(editorCell)}));
      setCellContext(editorCell);
  ...
  public static class GlobalConstant_component_cellMenu_o3ycrm_a0d0a implements SubstituteInfoPartExt {
    private controlledNameStuff myComponent;
    public GlobalConstant_component_cellMenu_o3ycrm_a0d0a() {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_o3ycrm_e0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new valueSingleRoleHandler_o3ycrm_f0a(myNode, LINKS.value$RmDl, getEditorContext());
    return provider.createCell();
  }
  private static class valueSingleRoleHandler_o3ycrm_f0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public valueSingleRoleHandler_o3ycrm_f0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ";");
    editorCell.setCellId("Constant_o3ycrm_g0a");
    Style style = new StyleImpl();
