...
public class GrammarCellsSubstituteMenu_CreateActors extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CreateActors() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CreateActors", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_1230a3_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_1230a3_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.CreateActors$rc;
    }
  }
