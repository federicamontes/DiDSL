...
public class GrammarCellsSubstituteMenu_ActorReference extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActorReference() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActorReference", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_onf8mx_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_onf8mx_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActorReference$Cg;
    }
  }
