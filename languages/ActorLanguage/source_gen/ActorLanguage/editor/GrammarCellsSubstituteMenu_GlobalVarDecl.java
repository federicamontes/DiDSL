...
public class GrammarCellsSubstituteMenu_GlobalVarDecl extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_GlobalVarDecl() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "GlobalVarDecl", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_e9on2x_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_e9on2x_a extends GrammarCellsSubstituteMenuPart {
    @Override
