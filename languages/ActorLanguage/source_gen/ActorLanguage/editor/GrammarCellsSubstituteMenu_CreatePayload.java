...
public class GrammarCellsSubstituteMenu_CreatePayload extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CreatePayload() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CreatePayload", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_dn4q3_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_dn4q3_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.CreatePayload$Pf;
    }
  }
