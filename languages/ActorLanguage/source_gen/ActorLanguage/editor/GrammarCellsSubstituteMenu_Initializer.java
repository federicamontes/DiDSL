...
public class GrammarCellsSubstituteMenu_Initializer extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Initializer() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Initializer", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_48pnab_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_48pnab_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.Initializer$mM;
    }
  }
