...
public class GrammarCellsSubstituteMenu_ForEachActorReferenceStatement extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ForEachActorReferenceStatement() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ForEachActorReferenceStatement", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_ghg1qd_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_ghg1qd_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ForEachActorReferenceStatement$Jq;
    }
  }
