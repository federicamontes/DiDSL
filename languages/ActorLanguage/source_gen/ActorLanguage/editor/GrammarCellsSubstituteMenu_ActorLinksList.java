...
public class GrammarCellsSubstituteMenu_ActorLinksList extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActorLinksList() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActorLinksList", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_j0fykv_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_j0fykv_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActorLinksList$l3;
    }
  }
