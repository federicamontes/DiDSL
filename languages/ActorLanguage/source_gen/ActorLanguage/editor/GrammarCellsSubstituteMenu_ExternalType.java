...
public class GrammarCellsSubstituteMenu_ExternalType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ExternalType() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ExternalType", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_gsy0rk_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_gsy0rk_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ExternalType$Bi;
    }
  }
