...
public abstract class SelectionSwitchCase {
  public static void AppendSelection(int from, int address, final TextGenContext ctx) {
    ...
    ctx.getBuffer().area().increaseIndent();
    tgs.indent();
    tgs.append("SelectionInit(topology, ");
    ...
    ctx.getBuffer().area().increaseIndent();
    tgs.indent();
    tgs.append("SelectionCleanUp((SelectionData *)s);");
    tgs.newLine();
    tgs.indent();
    tgs.append("break;");
    tgs.newLine();
    ...
    ctx.getBuffer().area().increaseIndent();
    tgs.indent();
    tgs.append("selection_data = (SelectionData *)s;");
    tgs.newLine();
    tgs.indent();
    tgs.append("selection_data->can_end = true;");
    tgs.newLine();
    tgs.indent();
