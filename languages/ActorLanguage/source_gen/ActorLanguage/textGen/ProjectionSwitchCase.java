...
public abstract class ProjectionSwitchCase {
  public static void AppendProjection(int from, int address, final TextGenContext ctx) {
    ...
    ctx.getBuffer().area().increaseIndent();
    tgs.indent();
    tgs.append("ProjectionInit(topology, ");
    ...
    ctx.getBuffer().area().increaseIndent();
    tgs.indent();
    tgs.append("ProjectionCleanUp((ProjectionData *)s);");
    tgs.newLine();
    tgs.indent();
    tgs.append("break;");
    tgs.newLine();
    ...
    ctx.getBuffer().area().increaseIndent();
    tgs.indent();
    tgs.append("projection_data = (ProjectionData *)s;");
    tgs.newLine();
    tgs.indent();
    tgs.append("projection_data->can_end = true;");
    tgs.newLine();
    tgs.indent();
